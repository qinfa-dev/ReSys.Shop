...
public sealed class QueryFilterBuilderTests(ITestOutputHelper output)
{
    ...
    public void Add_SingleFilter_BuildsCorrectly()
    {
        ...
        filters[0].Operator.Should().Be(FilterOperator.Equal);
        filters[0].Value.Should().Be("John Doe");
        filters[0].LogicalOperator.Should().Be(FilterLogicalOperator.All);
    }
    ...
    public void And_AddsAndFilter()
    {
        ...
        filters.All(f => f.LogicalOperator == FilterLogicalOperator.All).Should().BeTrue();
    }
    ...
    public void Or_AddsOrFilter()
    {
        ...
        // Assert
        filters.Count.Should().Be(2);
        filters.All(f => f.LogicalOperator == FilterLogicalOperator.Any).Should().BeTrue();
    }
    ...
    public void Contains_AddsContainsFilter()
    {
        ...
        filters[0].Value.Should().Be("john");
    }
    ...
    public void GreaterThan_AddsGreaterThanFilter()
    {
        ...
        // Assert
        filters.Count.Should().Be(1);
        filters[0].Operator.Should().Be(FilterOperator.GreaterThan);
        filters[0].Value.Should().Be("25");
    }
    ...
    public void LessThan_AddsLessThanFilter()
    {
        ...
        // Assert
        filters.Count.Should().Be(1);
        filters[0].Operator.Should().Be(FilterOperator.LessThan);
        filters[0].Value.Should().Be("35");
    }
    ...
    public void In_WithStringValues_AddsInFilter()
    {
        ...
        // Assert
        filters.Count.Should().Be(1);
        filters[0].Operator.Should().Be(FilterOperator.In);
        filters[0].Value.Should().Be("IT,HR,Finance");
    }
    ...
    public void Range_AddsRangeFilter()
    {
        ...
        // Assert
        filters.Count.Should().Be(1);
        filters[0].Operator.Should().Be(FilterOperator.Range);
        filters[0].Value.Should().Be("25,35");
    }
    ...
    public void IsNull_AddsNullCheckFilter()
    {
        ...
        // Assert
        filters.Count.Should().Be(1);
        filters[0].Operator.Should().Be(FilterOperator.IsNull);
    ...
    public void IsNotNull_AddsNotNullCheckFilter()
    {
        ...
        // Assert
        filters.Count.Should().Be(1);
        filters[0].Operator.Should().Be(FilterOperator.IsNotNull);
        filters[0].Value.Should().Be(string.Empty);
    }
    ...
    public void InGroup_SetsGroupForSubsequentFilters()
    {
        ...
        // Assert
        filters.Count.Should().Be(3);
        filters[0].Group.Should().Be(1);
        filters[1].Group.Should().Be(1);
        filters[2].Group.Should().Be(2);
    }
    ...
    public void ComplexBuilder_WithMixedOperators_BuildsCorrectly()
    {
        ...
        filters.Where(f => f.Group == 0).All(f => f.LogicalOperator == FilterLogicalOperator.Any).Should().BeTrue();

        // Group 1 filters should use AND
        filters.Where(f => f.Group == 1).All(f => f.LogicalOperator == FilterLogicalOperator.All).Should().BeTrue();
    }
    ...
    public void ApplyTo_WithOrLogic_AppliesFiltersCorrectly()
    {
        ...
        // Assert
        result.Count().Should().Be(2); // John and Jane
    ...
    public void ApplyTo_WithComplexGrouping_AppliesFiltersCorrectly()
    {
        ...
        result.All(u => u.Department == "IT").Should().BeTrue();
        result.Select(u => u.Name).OrderBy(n => n).Should().Contain(["Bob Johnson", "Charlie Wilson", "John Doe"]);
    }
    ...
    public void MethodChaining_AllowsFluentInterface()
    {
        ...
        // Assert
        filters.Count.Should().Be(6);
        filters.All(f => f.Group == 1).Should().BeTrue();
        filters.All(f => f.LogicalOperator == FilterLogicalOperator.Any).Should().BeTrue();
    }
}
