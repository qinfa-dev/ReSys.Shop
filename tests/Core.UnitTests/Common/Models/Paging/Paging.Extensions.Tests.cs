...
public sealed class PagingExtensionsTests
{
    ...
    public void ApplyPagingOrDefault_NullPagingParams_ReturnsDefaultPageSize()
    {
        ...
        result.Count.Should().Be(3); // All items, less than default page size (10)
    ...
    public void ApplyPagingOrDefault_WithPageSize_ReturnsFirstPageWithSpecifiedSize()
    {
        ...
        result[0].Id.Should().Be(1); // John Doe
        result[1].Id.Should().Be(2); // Jane Smith
    }
    ...
    public void ApplyPagingOrDefault_WithPageSizeAndPageIndex_ReturnsCorrectPage()
    {
        ...
        result[0].Id.Should().Be(2); // Jane Smith (second item, page index 1 with page size 1)
    }
    ...
    public void ApplyPagingOrDefault_WithPageIndex_ReturnsSecondPageWithDefaultSize()
    {
        ...
        result.Count.Should().Be(0); // No items on page index 1 (page 2) with default page size (10)
    }
    ...
    public void ApplyPagingOrDefault_NegativeFallbackPageSize_UsesDefault()
    {
        ...
        result.Count.Should().Be(3); // All items, uses default page size (10)
        result[0].Id.Should().Be(1);
        result[1].Id.Should().Be(2);
        result[2].Id.Should().Be(3);
    }
    ...
    public void ApplyPagingOrDefault_ExcessivePageSize_CapsAtMax()
    {
        ...
        result.Count.Should().Be(3); // All items, capped at max page size (100)
        result[0].Id.Should().Be(1);
        result[1].Id.Should().Be(2);
        result[2].Id.Should().Be(3);
    }
    ...
    public void ApplyPagingOrDefault_BeyondTotalItems_ReturnsEmpty()
    {
        ...
        result.Count.Should().Be(0); // No items on page index 2 with 5 items per page
    }
    ...
    public void ApplyPagingOrDefault_WithSort_AppliesCorrectly()
    {
        ...
        result.Count.Should().Be(2);
        result[0].Name.Should().Be("Bob Johnson"); // Alphabetical order
    ...
    public void ApplyPagingOrDefault_ZeroPageSize_UsesDefault()
    {
        ...
        result.Count.Should().Be(3); // Uses default page size (10)
    }
    ...
    public void ApplyPagingOrDefault_NullQuery_ThrowsArgumentNullException()
    {
        ...
        ((Action)(() => query!.ApplyPagingOrDefault(@params))).Should().Throw<ArgumentNullException>();
    }
    ...
    public void ApplyPagingOrAll_NullPagingParams_ReturnsAllRecords()
    {
        ...
        result.Count.Should().Be(3); // All items, no pagination
        result[0].Id.Should().Be(1);
        result[1].Id.Should().Be(2);
        result[2].Id.Should().Be(3);
    }
    ...
    public void ApplyPagingOrAll_DefaultParams_ReturnsAllRecords()
    {
        ...
        result.Count.Should().Be(3); // All items, no valid paging values
        result[0].Id.Should().Be(1);
        result[1].Id.Should().Be(2);
        result[2].Id.Should().Be(3);
    }
    ...
    public void ApplyPagingOrAll_WithPageSizeAndPageIndex_ReturnsCorrectPage()
    {
        ...
        result.Count.Should().Be(1); // Third item
        result[0].Id.Should().Be(3); // Bob Johnson
    }
    ...
    public void ApplyPagingOrAll_NegativePageIndex_NormalizesToFirstPage()
    {
        ...
        result.Count.Should().Be(2); // Normalized to page index 0, returns first 2 items
        result[0].Id.Should().Be(1);
        result[1].Id.Should().Be(2);
    }
    ...
    public void ApplyPagingOrAll_MaxAllItemsLimit_CapsResults()
    {
        ...
        result.Count.Should().Be(100); // Capped at maxAllItemsLimit
        result[0].Id.Should().Be(1);
    ...
    public void ApplyPagingOrAll_ExtremeMaxLimit_UsesConfiguredMax()
    {
        ...
        result.Count.Should().Be(3); // Still limited by actual data count, but capped at MaxAllItemsLimit (1000)
    }
    ...
    public void ApplyPagingOrAll_NegativeMaxLimit_UsesMinimum()
    {
        ...
        result.Count.Should().Be(1); // Uses minimum of 1
    }
    ...
    public void ApplyPagingOrAll_NullQuery_ThrowsArgumentNullException()
    {
        ...
        ((Action)(() => query!.ApplyPagingOrAll(@params))).Should().Throw<ArgumentNullException>();
    }
    ...
    public void ApplyPagingOrDefault_LargeDataSet_PerformanceTest()
    {
        ...
        result[0].Id.Should().Be(1001); // (50 * 20) + 1 = 1001
        stopwatch.ElapsedMilliseconds.Should().BeLessThan(100); // Should be fast for in-memory operations
    }
