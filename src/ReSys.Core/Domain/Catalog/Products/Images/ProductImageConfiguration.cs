...
public sealed class ProductImageConfiguration : IEntityTypeConfiguration<ProductImage>
{
    public void Configure(EntityTypeBuilder<ProductImage> builder)
    {
        ...
        // Vector similarity index using HNSW for OpenCLIP
        ...
        builder.Property(propertyExpression: pi => pi.EmbeddingDinoV2)
            .HasColumnType(typeName: "vector(1024)") // Estimated dimension, verify with chosen DINOv2 variant
            .IsRequired(required: false)
            .HasComment(comment: "EmbeddingDinoV2: Embedding vector generated by DINOv2 model for visual similarity search.");

        // Vector similarity index using HNSW for DINOv2
        ...
        builder.Property(propertyExpression: pi => pi.EmbeddingBLIP2)
            .HasColumnType(typeName: "vector(768)") // Estimated dimension, verify with chosen BLIP-2 variant
            .IsRequired(required: false)
            .HasComment(comment: "EmbeddingBLIP2: Embedding vector generated by BLIP-2 model for visual similarity search.");

        // Vector similarity index using HNSW for BLIP-2
