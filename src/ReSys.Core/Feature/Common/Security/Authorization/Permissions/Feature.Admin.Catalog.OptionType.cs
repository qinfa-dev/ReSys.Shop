        ...
        public static partial class Catalog
        {
            public static class OptionType
            {
                ...
                public static AccessPermission Update => AccessPermission.Create(
                    name: "admin.option_type.update").Value;
                public static AccessPermission Delete => AccessPermission.Create(name: "admin.option_type.delete").Value;
