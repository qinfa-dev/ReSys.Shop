...
public static partial class Feature
{
    public static partial class Admin
    {
        public static partial class Catalog
        {
            ...
            {
                public static AccessPermission Create  => AccessPermission.Create(name: "admin.property.create",
                    displayName: "Create Property",
                    description: "Allows creating a new property").Value;
                public static AccessPermission List  => AccessPermission.Create(name: "admin.property.list",
                    displayName: "View Properties",
                    description: "Allows viewing properties").Value;
                public static AccessPermission View  => AccessPermission.Create(name: "admin.property.view",
                    displayName: "View Property Details",
                    description: "Allows viewing detailed information about a property").Value;
                public static AccessPermission Update  => AccessPermission.Create(name: "admin.property.update",
                    displayName: "Update Property",
                    description: "Allows updating an existing property").Value;
                public static AccessPermission Delete  => AccessPermission.Create(name: "admin.property.delete",
